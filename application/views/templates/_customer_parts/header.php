        ...
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-dark navbar-expand-lg">
                    <a class="navbar-brand" href="<?= base_url('product') ?>">iorder</a>
                    <!-- <a class="navbar-brand" href="index.html"><img src="<?= base_url('assets-user/') ?>images/logo.png" class="img-fluid" alt="logo"></a> -->
                    <a class="navbar-brand" href="<?= base_url('product/detail_order') ?>">
                        <span class="ti-shopping-cart"></span>
                        <span id="qty_order" class="badge badge-success navbar-badge"><?= $qty_order; ?></span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a href="<?= base_url('product/list_order') ?>" class="btn btn-outline-light my-3 my-sm-0 ml-lg-3">Pesanan</a></li>
